...
import numpy as np
from meta_rnnprop_mt import _make_with_custom_variables
import random
...
class data_loader():
    def __init__(self, make_loss, x, constants, subsets, scale, optimizers, unroll_len, hess_norm):
    ...
    def get_data(self, task_i, sess, num_unrolls, assign_func, rd_scale_bound, if_scale=True, mt_k=1, if_hess_init=False):
